...
import { useGetStoryPurchaseStatsQuery } from "../../../redux/features/storyPurchases/storyPurchases";

const StoryPurchasesStats = () => {
  const { data } = useGetStoryPurchaseStatsQuery();
  ...
  const stats = [
    ...
    { label: "Stories Used", value: data?.totalStoriesUsed ?? 0, icon: <LuBookOpen size={20} />, bg: "bg-indigo-50", color: "text-indigo-600" },
  ];
...
export default StoryPurchasesStats;
